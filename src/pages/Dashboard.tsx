      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {documents.map(doc => <Card key={doc.id} hover className="overflow-hidden">
              ...
              {doc.status !== 'complete' ? <ProgressIndicator progress={doc.progress} status={doc.status as any} className="mb-4" /> : <div className="mb-4 p-3 bg-neutral-50 rounded-lg border border-neutral-200">
